	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8007e8:	0f be 80 c4 17 80 00 	movsbl 0x8017c4(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009af:	c7 44 24 08 dc 17 80 	movl   $0x8017dc,0x8(%esp)
  8009b6:	00 
  ...
  8009cf:	c7 44 24 08 e5 17 80 	movl   $0x8017e5,0x8(%esp)
  8009d6:	00 
  ...
  800a01:	b8 d5 17 80 00       	mov    $0x8017d5,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801355:	75 58                	jne    8013af <set_pgfault_handler+0x67>
	{
		// First time through!
  ...
  80137b:	c7 44 24 08 2f 1a 80 	movl   $0x801a2f,0x8(%esp)
  801382:	00 
  801383:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  80138a:	00 
  80138b:	c7 04 24 45 1a 80 00 	movl   $0x801a45,(%esp)
  801392:	e8 60 f2 ff ff       	call   8005f7 <_panic>
		}
		
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  801397:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  80139c:	8b 40 48             	mov    0x48(%eax),%eax
  80139f:	c7 44 24 04 b9 13 80 	movl   $0x8013b9,0x4(%esp)
  8013a6:	00 
  8013a7:	89 04 24             	mov    %eax,(%esp)
  8013aa:	e8 d1 fe ff ff       	call   801280 <sys_env_set_pgfault_upcall>
  ...
  8013b2:	a3 d0 20 80 00       	mov    %eax,0x8020d0
}
  8013b7:	c9                   	leave  
  8013b8:	c3                   	ret    

008013b9 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  8013ba:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
