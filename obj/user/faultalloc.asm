...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800eb5:	75 58                	jne    800f0f <set_pgfault_handler+0x67>
	{
		// First time through!
  ...
  800edb:	c7 44 24 08 ef 14 80 	movl   $0x8014ef,0x8(%esp)
  800ee2:	00 
  800ee3:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  800eea:	00 
  800eeb:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
  800ef2:	e8 59 f2 ff ff       	call   800150 <_panic>
		}
		
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800ef7:	a1 04 20 80 00       	mov    0x802004,%eax
  800efc:	8b 40 48             	mov    0x48(%eax),%eax
  800eff:	c7 44 24 04 19 0f 80 	movl   $0x800f19,0x4(%esp)
  800f06:	00 
  800f07:	89 04 24             	mov    %eax,(%esp)
  800f0a:	e8 d1 fe ff ff       	call   800de0 <sys_env_set_pgfault_upcall>
  ...
  800f12:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800f17:	c9                   	leave  
  800f18:	c3                   	ret    

00800f19 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800f1a:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
