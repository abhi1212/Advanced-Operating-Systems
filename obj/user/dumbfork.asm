...
duppage(envid_t dstenv, void *addr)
{
  ...
  800071:	00 
  800072:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800079:	00 
  80007a:	c7 04 24 b3 12 80 00 	movl   $0x8012b3,(%esp)
  800081:	e8 2f 02 00 00       	call   8002b5 <_panic>
  ...
  8000b9:	00 
  8000ba:	c7 44 24 04 24 00 00 	movl   $0x24,0x4(%esp)
  8000c1:	00 
  8000c2:	c7 04 24 b3 12 80 00 	movl   $0x8012b3,(%esp)
  8000c9:	e8 e7 01 00 00       	call   8002b5 <_panic>
  ...
  800109:	00 
  80010a:	c7 44 24 04 27 00 00 	movl   $0x27,0x4(%esp)
  800111:	00 
  800112:	c7 04 24 b3 12 80 00 	movl   $0x8012b3,(%esp)
  800119:	e8 97 01 00 00       	call   8002b5 <_panic>
}
...
sys_exofork(void)
{
  ...
  800134:	89 c6                	mov    %eax,%esi
	...
	envid = sys_exofork();
	//cprintf("enid values in fork is %d\n",envid);
	if (envid < 0)
  ...
  800145:	00 
  800146:	c7 44 24 04 3a 00 00 	movl   $0x3a,0x4(%esp)
  80014d:	00 
  80014e:	c7 04 24 b3 12 80 00 	movl   $0x8012b3,(%esp)
  800155:	e8 5b 01 00 00       	call   8002b5 <_panic>
  ...
  8001d8:	00 
  8001d9:	c7 44 24 04 4f 00 00 	movl   $0x4f,0x4(%esp)
  8001e0:	00 
  8001e1:	c7 04 24 b3 12 80 00 	movl   $0x8012b3,(%esp)
  8001e8:	e8 c8 00 00 00       	call   8002b5 <_panic>
...
umain(int argc, char **argv)
{
  ...
  8001fb:	83 ec 10             	sub    $0x10,%esp
	...
	cprintf("Hi iam here\n");
  8001fe:	c7 04 24 1b 13 80 00 	movl   $0x80131b,(%esp)
  800205:	e8 a4 01 00 00       	call   8003ae <cprintf>
	who = dumbfork();
  80020a:	e8 16 ff ff ff       	call   800125 <dumbfork>
  ...
  800216:	eb 28                	jmp    800240 <umain+0x4a>
		cprintf("%d: I am the %s!\n", i, who ? "parent" : "child");
  800218:	b8 15 13 80 00       	mov    $0x801315,%eax
  80021d:	eb 05                	jmp    800224 <umain+0x2e>
  80021f:	b8 0e 13 80 00       	mov    $0x80130e,%eax
  800224:	89 44 24 08          	mov    %eax,0x8(%esp)
  800228:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80022c:	c7 04 24 28 13 80 00 	movl   $0x801328,(%esp)
  800233:	e8 76 01 00 00       	call   8003ae <cprintf>
		sys_yield();
  800238:	e8 97 0b 00 00       	call   800dd4 <sys_yield>
	cprintf("Hi iam here\n");
	who = dumbfork();
  ...
  800240:	85 f6                	test   %esi,%esi
  800242:	75 07                	jne    80024b <umain+0x55>
  800244:	83 fb 13             	cmp    $0x13,%ebx
  800247:	7e cf                	jle    800218 <umain+0x22>
  800249:	eb 07                	jmp    800252 <umain+0x5c>
  80024b:	83 fb 09             	cmp    $0x9,%ebx
  80024e:	66 90                	xchg   %ax,%ax
  800250:	7e cd                	jle    80021f <umain+0x29>
		cprintf("%d: I am the %s!\n", i, who ? "parent" : "child");
		sys_yield();
	}
}
...
libmain(int argc, char **argv)
{
  ...
  800261:	8b 5d 08             	mov    0x8(%ebp),%ebx
  800264:	8b 75 0c             	mov    0xc(%ebp),%esi
	// set thisenv to point at our Env structure in envs[].
	// LAB 3: Your code here.
	
	thisenv = (struct Env*)envs + ENVX(sys_getenvid());
  800267:	e8 49 0b 00 00       	call   800db5 <sys_getenvid>
  80026c:	25 ff 03 00 00       	and    $0x3ff,%eax
  800271:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800274:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800279:	a3 04 20 80 00       	mov    %eax,0x802004
  ...
  800284:	a3 00 20 80 00       	mov    %eax,0x802000

	// call user main routine
	umain(argc, argv);
  800289:	89 74 24 04          	mov    %esi,0x4(%esp)
  80028d:	89 1c 24             	mov    %ebx,(%esp)
  800290:	e8 61 ff ff ff       	call   8001f6 <umain>

	// exit gracefully
	exit();
  800295:	e8 07 00 00 00       	call   8002a1 <exit>
}
...
exit(void)
{
  ...
  8002ae:	e8 b0 0a 00 00       	call   800d63 <sys_env_destroy>
}
  8002b3:	c9                   	leave  
  8002b4:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8002c0:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8002c6:	e8 ea 0a 00 00       	call   800db5 <sys_getenvid>
  ...
  8002e1:	c7 04 24 44 13 80 00 	movl   $0x801344,(%esp)
  ...
  8002f7:	e8 51 00 00 00       	call   80034d <vcprintf>
	cprintf("\n");
  8002fc:	c7 04 24 38 13 80 00 	movl   $0x801338,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  800338:	e8 e9 09 00 00       	call   800d26 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800389:	e8 b0 01 00 00       	call   80053e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8003a1:	e8 80 09 00 00       	call   800d26 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004a8:	0f be 80 68 13 80 00 	movsbl 0x801368(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80066f:	c7 44 24 08 80 13 80 	movl   $0x801380,0x8(%esp)
  800676:	00 
  ...
  80068f:	c7 44 24 08 89 13 80 	movl   $0x801389,0x8(%esp)
  800696:	00 
  ...
  8006c1:	b8 79 13 80 00       	mov    $0x801379,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800d90:	00 
  800d91:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800d98:	00 
  800d99:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da0:	00 
  800da1:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
  800da8:	e8 08 f5 ff ff       	call   8002b5 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e22:	00 
  800e23:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800e2a:	00 
  800e2b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e32:	00 
  800e33:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
  800e3a:	e8 76 f4 ff ff       	call   8002b5 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e75:	00 
  800e76:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800e7d:	00 
  800e7e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e85:	00 
  800e86:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
  800e8d:	e8 23 f4 ff ff       	call   8002b5 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ec8:	00 
  800ec9:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800ed0:	00 
  800ed1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ed8:	00 
  800ed9:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
  800ee0:	e8 d0 f3 ff ff       	call   8002b5 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f1b:	00 
  800f1c:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800f23:	00 
  800f24:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f2b:	00 
  800f2c:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
  800f33:	e8 7d f3 ff ff       	call   8002b5 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f6e:	00 
  800f6f:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800f76:	00 
  800f77:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f7e:	00 
  800f7f:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
  800f86:	e8 2a f3 ff ff       	call   8002b5 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800fe3:	00 
  800fe4:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800feb:	00 
  800fec:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ff3:	00 
  800ff4:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
  800ffb:	e8 b5 f2 ff ff       	call   8002b5 <_panic>
