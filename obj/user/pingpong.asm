...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 2c             	sub    $0x2c,%esp
	...
	if ((who = fork()) != 0) {
  80003c:	e8 44 0f 00 00       	call   800f85 <fork>
  ...
  80004d:	eb 3e                	jmp    80008d <umain+0x5a>
{
  ...
  80005c:	c7 04 24 60 16 80 00 	movl   $0x801660,(%esp)
  ...
  800086:	e8 ed 11 00 00       	call   801278 <ipc_send>
  ...
  8000a0:	e8 b1 11 00 00       	call   801256 <ipc_recv>
  ...
  8000bb:	c7 04 24 76 16 80 00 	movl   $0x801676,(%esp)
  ...
  8000e9:	e8 8a 11 00 00       	call   801278 <ipc_send>
		if (i == 10)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	e8 2c 11 00 00       	call   8013c0 <__udivdi3>
  ...
  8002ef:	e8 fc 11 00 00       	call   8014f0 <__umoddi3>
  8002f4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002f8:	0f be 80 93 16 80 00 	movsbl 0x801693(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800413:	ff 24 8d 60 17 80 00 	jmp    *0x801760(,%ecx,4)
  ...
  8004df:	c7 44 24 08 b4 16 80 	movl   $0x8016b4,0x8(%esp)
  8004e6:	00 
  ...
  800511:	b8 a4 16 80 00       	mov    $0x8016a4,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800be0:	00 
  800be1:	c7 44 24 08 e4 18 80 	movl   $0x8018e4,0x8(%esp)
  800be8:	00 
  800be9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf0:	00 
  800bf1:	c7 04 24 01 19 80 00 	movl   $0x801901,(%esp)
  800bf8:	e8 d5 06 00 00       	call   8012d2 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c72:	00 
  800c73:	c7 44 24 08 e4 18 80 	movl   $0x8018e4,0x8(%esp)
  800c7a:	00 
  800c7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c82:	00 
  800c83:	c7 04 24 01 19 80 00 	movl   $0x801901,(%esp)
  800c8a:	e8 43 06 00 00       	call   8012d2 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cc5:	00 
  800cc6:	c7 44 24 08 e4 18 80 	movl   $0x8018e4,0x8(%esp)
  800ccd:	00 
  800cce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd5:	00 
  800cd6:	c7 04 24 01 19 80 00 	movl   $0x801901,(%esp)
  800cdd:	e8 f0 05 00 00       	call   8012d2 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d18:	00 
  800d19:	c7 44 24 08 e4 18 80 	movl   $0x8018e4,0x8(%esp)
  800d20:	00 
  800d21:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d28:	00 
  800d29:	c7 04 24 01 19 80 00 	movl   $0x801901,(%esp)
  800d30:	e8 9d 05 00 00       	call   8012d2 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d6b:	00 
  800d6c:	c7 44 24 08 e4 18 80 	movl   $0x8018e4,0x8(%esp)
  800d73:	00 
  800d74:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d7b:	00 
  800d7c:	c7 04 24 01 19 80 00 	movl   $0x801901,(%esp)
  800d83:	e8 4a 05 00 00       	call   8012d2 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dbe:	00 
  800dbf:	c7 44 24 08 e4 18 80 	movl   $0x8018e4,0x8(%esp)
  800dc6:	00 
  800dc7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dce:	00 
  800dcf:	c7 04 24 01 19 80 00 	movl   $0x801901,(%esp)
  800dd6:	e8 f7 04 00 00       	call   8012d2 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e33:	00 
  800e34:	c7 44 24 08 e4 18 80 	movl   $0x8018e4,0x8(%esp)
  800e3b:	00 
  800e3c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e43:	00 
  800e44:	c7 04 24 01 19 80 00 	movl   $0x801901,(%esp)
  800e4b:	e8 82 04 00 00       	call   8012d2 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e64:	8b 48 04             	mov    0x4(%eax),%ecx
  ...
  800e73:	a9 02 08 00 00       	test   $0x802,%eax
  800e78:	75 21                	jne    800e9b <pgfault+0x43>
  800e7a:	f6 c1 02             	test   $0x2,%cl
  800e7d:	74 1c                	je     800e9b <pgfault+0x43>
		panic("Trying to write on a read only page or the error is not a Write error");
  800e7f:	c7 44 24 08 10 19 80 	movl   $0x801910,0x8(%esp)
  800e86:	00 
  800e87:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e8e:	00 
  800e8f:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  800e96:	e8 37 04 00 00       	call   8012d2 <_panic>
  ...
  800eaa:	00 
  800eab:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800eb2:	00 
  800eb3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800eba:	e8 84 fd ff ff       	call   800c43 <sys_page_alloc>
  800ebf:	85 c0                	test   %eax,%eax
  800ec1:	79 20                	jns    800ee3 <pgfault+0x8b>
		panic("sys_page_alloc: %e", r);
  800ec3:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800ec7:	c7 44 24 08 8d 19 80 	movl   $0x80198d,0x8(%esp)
  800ece:	00 
  800ecf:	c7 44 24 04 2d 00 00 	movl   $0x2d,0x4(%esp)
  800ed6:	00 
  800ed7:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  800ede:	e8 ef 03 00 00       	call   8012d2 <_panic>
		
	memmove((void *)PFTEMP, vAddr, PGSIZE);
  800ee3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800eea:	00 
  800eeb:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800eef:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800ef6:	e8 c9 fa ff ff       	call   8009c4 <memmove>
	
	if ((r = sys_page_map(0, (void *)PFTEMP, 0, vAddr, PTE_P|PTE_U|PTE_W)) < 0)
  800efb:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800f02:	00 
  800f03:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  800f07:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800f0e:	00 
  800f0f:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f16:	00 
  800f17:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800f1e:	e8 74 fd ff ff       	call   800c97 <sys_page_map>
  800f23:	85 c0                	test   %eax,%eax
  800f25:	79 20                	jns    800f47 <pgfault+0xef>
		panic("sys_page_map: %e", r);
  800f27:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f2b:	c7 44 24 08 a0 19 80 	movl   $0x8019a0,0x8(%esp)
  800f32:	00 
  800f33:	c7 44 24 04 32 00 00 	movl   $0x32,0x4(%esp)
  800f3a:	00 
  800f3b:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  800f42:	e8 8b 03 00 00       	call   8012d2 <_panic>
  ...
  800f56:	e8 8f fd ff ff       	call   800cea <sys_page_unmap>
  800f5b:	85 c0                	test   %eax,%eax
  800f5d:	79 20                	jns    800f7f <pgfault+0x127>
		panic("sys_page_unmap: %e", r);
  800f5f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f63:	c7 44 24 08 b1 19 80 	movl   $0x8019b1,0x8(%esp)
  800f6a:	00 
  800f6b:	c7 44 24 04 37 00 00 	movl   $0x37,0x4(%esp)
  800f72:	00 
  800f73:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  800f7a:	e8 53 03 00 00       	call   8012d2 <_panic>

}
  800f7f:	83 c4 24             	add    $0x24,%esp
  800f82:	5b                   	pop    %ebx
  800f83:	5d                   	pop    %ebp
  800f84:	c3                   	ret    
...
fork(void)
{
  ...
  800f8e:	c7 04 24 58 0e 80 00 	movl   $0x800e58,(%esp)
  800f95:	e8 8e 03 00 00       	call   801328 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800fa8:	79 20                	jns    800fca <fork+0x45>
		panic("sys_exofork: %e", envid);
  800faa:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fae:	c7 44 24 08 c4 19 80 	movl   $0x8019c4,0x8(%esp)
  800fb5:	00 
  800fb6:	c7 44 24 04 83 00 00 	movl   $0x83,0x4(%esp)
  800fbd:	00 
  800fbe:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  800fc5:	e8 08 03 00 00       	call   8012d2 <_panic>
	if (envid == 0) {
  800fca:	bb 00 08 00 00       	mov    $0x800,%ebx
  800fcf:	85 c0                	test   %eax,%eax
  800fd1:	75 21                	jne    800ff4 <fork+0x6f>
		// We're the child.
		// The copied value of the global variable 'thisenv'
		// is no longer valid (it refers to the parent!).
		// Fix it and return 0.
		thisenv = &envs[ENVX(sys_getenvid())];
  800fd3:	e8 2d fc ff ff       	call   800c05 <sys_getenvid>
  800fd8:	25 ff 03 00 00       	and    $0x3ff,%eax
  800fdd:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800fe0:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800fe5:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  800fea:	b8 00 00 00 00       	mov    $0x0,%eax
  800fef:	e9 38 02 00 00       	jmp    80122c <fork+0x2a7>
	}
	uint32_t i=0;
  ...
  801008:	0f 84 69 01 00 00    	je     801177 <fork+0x1f2>
		if(!(uvpt[pn] & PTE_P)) continue;
  80100e:	8b 14 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%edx
  801015:	f6 c2 01             	test   $0x1,%dl
  801018:	0f 84 59 01 00 00    	je     801177 <fork+0x1f2>
		if((pn << PGSHIFT) < (UXSTACKTOP - PGSIZE))
  80101e:	3d ff ef bf ee       	cmp    $0xeebfefff,%eax
  801023:	0f 87 4e 01 00 00    	ja     801177 <fork+0x1f2>
  ...
  80102b:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  801032:	a8 02                	test   $0x2,%al
  801034:	75 10                	jne    801046 <fork+0xc1>
  801036:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  80103d:	f6 c4 08             	test   $0x8,%ah
  801040:	0f 84 93 00 00 00    	je     8010d9 <fork+0x154>
	{
  ...
  801064:	e8 2e fc ff ff       	call   800c97 <sys_page_map>
  801069:	85 c0                	test   %eax,%eax
  80106b:	79 20                	jns    80108d <fork+0x108>
			panic("sys_page_map: %e", r);
  80106d:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801071:	c7 44 24 08 a0 19 80 	movl   $0x8019a0,0x8(%esp)
  801078:	00 
  801079:	c7 44 24 04 56 00 00 	movl   $0x56,0x4(%esp)
  801080:	00 
  801081:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  801088:	e8 45 02 00 00       	call   8012d2 <_panic>
		if ((r = sys_page_map(0, address, 0, address, perm)) < 0)
  80108d:	c7 44 24 10 05 08 00 	movl   $0x805,0x10(%esp)
  801094:	00 
  ...
  8010ac:	e8 e6 fb ff ff       	call   800c97 <sys_page_map>
  8010b1:	85 c0                	test   %eax,%eax
  8010b3:	0f 89 be 00 00 00    	jns    801177 <fork+0x1f2>
			panic("sys_page_map: %e", r);
  8010b9:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010bd:	c7 44 24 08 a0 19 80 	movl   $0x8019a0,0x8(%esp)
  8010c4:	00 
  8010c5:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8010cc:	00 
  8010cd:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  8010d4:	e8 f9 01 00 00       	call   8012d2 <_panic>
	}

	else if(uvpt[pn] & PTE_U)
  8010d9:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  8010e0:	a8 04                	test   $0x4,%al
  8010e2:	0f 84 8f 00 00 00    	je     801177 <fork+0x1f2>
	{
		if ((r = sys_page_map(0, address, envid, address, perm1)) < 0)
  8010e8:	c7 44 24 10 05 00 00 	movl   $0x5,0x10(%esp)
  8010ef:	00 
  8010f0:	89 74 24 0c          	mov    %esi,0xc(%esp)
  8010f4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8010f7:	89 44 24 08          	mov    %eax,0x8(%esp)
  8010fb:	89 74 24 04          	mov    %esi,0x4(%esp)
  8010ff:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801106:	e8 8c fb ff ff       	call   800c97 <sys_page_map>
  80110b:	85 c0                	test   %eax,%eax
  80110d:	79 20                	jns    80112f <fork+0x1aa>
			panic("sys_page_map: %e", r);
  80110f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801113:	c7 44 24 08 a0 19 80 	movl   $0x8019a0,0x8(%esp)
  80111a:	00 
  80111b:	c7 44 24 04 5e 00 00 	movl   $0x5e,0x4(%esp)
  801122:	00 
  801123:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  80112a:	e8 a3 01 00 00       	call   8012d2 <_panic>
		if ((r = sys_page_map(0, address, 0, address, perm1)) < 0)
  80112f:	c7 44 24 10 05 00 00 	movl   $0x5,0x10(%esp)
  801136:	00 
  ...
  80114e:	e8 44 fb ff ff       	call   800c97 <sys_page_map>
  801153:	85 c0                	test   %eax,%eax
  801155:	79 20                	jns    801177 <fork+0x1f2>
			panic("sys_page_map: %e", r);
  801157:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80115b:	c7 44 24 08 a0 19 80 	movl   $0x8019a0,0x8(%esp)
  801162:	00 
  801163:	c7 44 24 04 60 00 00 	movl   $0x60,0x4(%esp)
  80116a:	00 
  80116b:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  801172:	e8 5b 01 00 00       	call   8012d2 <_panic>
		// Fix it and return 0.
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
  ...
  80117a:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  801180:	0f 85 6e fe ff ff    	jne    800ff4 <fork+0x6f>
  ...
  8011a0:	79 20                	jns    8011c2 <fork+0x23d>
		panic("sys_page_alloc: %e", r);
  8011a2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011a6:	c7 44 24 08 8d 19 80 	movl   $0x80198d,0x8(%esp)
  8011ad:	00 
  8011ae:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  8011b5:	00 
  8011b6:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  8011bd:	e8 10 01 00 00       	call   8012d2 <_panic>
		
	int status;
	if((status =sys_env_set_pgfault_upcall(envid, thisenv->env_pgfault_upcall)) < 0)
  8011c2:	a1 04 20 80 00       	mov    0x802004,%eax
  8011c7:	8b 40 60             	mov    0x60(%eax),%eax
  8011ca:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011ce:	89 3c 24             	mov    %edi,(%esp)
  8011d1:	e8 ba fb ff ff       	call   800d90 <sys_env_set_pgfault_upcall>
  8011d6:	85 c0                	test   %eax,%eax
  8011d8:	79 1c                	jns    8011f6 <fork+0x271>
		panic("Bad Environment in user pagefault handler");
  8011da:	c7 44 24 08 58 19 80 	movl   $0x801958,0x8(%esp)
  8011e1:	00 
  8011e2:	c7 44 24 04 a0 00 00 	movl   $0xa0,0x4(%esp)
  8011e9:	00 
  8011ea:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  8011f1:	e8 dc 00 00 00       	call   8012d2 <_panic>
			
	if ((r = sys_env_set_status(envid, ENV_RUNNABLE)) < 0)
  8011f6:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  8011fd:	00 
  8011fe:	89 3c 24             	mov    %edi,(%esp)
  801201:	e8 37 fb ff ff       	call   800d3d <sys_env_set_status>
  801206:	85 c0                	test   %eax,%eax
  801208:	79 20                	jns    80122a <fork+0x2a5>
		panic("sys_env_set_status: %e", r);
  80120a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80120e:	c7 44 24 08 d4 19 80 	movl   $0x8019d4,0x8(%esp)
  801215:	00 
  801216:	c7 44 24 04 a3 00 00 	movl   $0xa3,0x4(%esp)
  80121d:	00 
  80121e:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  801225:	e8 a8 00 00 00       	call   8012d2 <_panic>
		
	return envid;
  80122a:	89 f8                	mov    %edi,%eax
}
  80122c:	83 c4 2c             	add    $0x2c,%esp
  80122f:	5b                   	pop    %ebx
  801230:	5e                   	pop    %esi
  801231:	5f                   	pop    %edi
  801232:	5d                   	pop    %ebp
...
sfork(void)
{
  ...
  80123a:	c7 44 24 08 eb 19 80 	movl   $0x8019eb,0x8(%esp)
  801241:	00 
  801242:	c7 44 24 04 ac 00 00 	movl   $0xac,0x4(%esp)
  801249:	00 
  80124a:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  801251:	e8 7c 00 00 00       	call   8012d2 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80125c:	c7 44 24 08 01 1a 80 	movl   $0x801a01,0x8(%esp)
  801263:	00 
  801264:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  80126b:	00 
  80126c:	c7 04 24 1a 1a 80 00 	movl   $0x801a1a,(%esp)
  801273:	e8 5a 00 00 00       	call   8012d2 <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80127e:	c7 44 24 08 24 1a 80 	movl   $0x801a24,0x8(%esp)
  801285:	00 
  801286:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80128d:	00 
  80128e:	c7 04 24 1a 1a 80 00 	movl   $0x801a1a,(%esp)
  801295:	e8 38 00 00 00       	call   8012d2 <_panic>

0080129a <ipc_find_env>:
...
ipc_find_env(enum EnvType type)
{
  ...
  8012b3:	75 0d                	jne    8012c2 <ipc_find_env+0x28>
			return envs[i].env_id;
  8012b5:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8012b8:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8012bd:	8b 40 40             	mov    0x40(%eax),%eax
  8012c0:	eb 0e                	jmp    8012d0 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8012c5:	3d 00 04 00 00       	cmp    $0x400,%eax
  8012ca:	75 d9                	jne    8012a5 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  8012cc:	66 b8 00 00          	mov    $0x0,%ax
}
  8012d0:	5d                   	pop    %ebp
  8012d1:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012d7:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  8012da:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8012dd:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8012e3:	e8 1d f9 ff ff       	call   800c05 <sys_getenvid>
  8012e8:	8b 55 0c             	mov    0xc(%ebp),%edx
  8012eb:	89 54 24 10          	mov    %edx,0x10(%esp)
  8012ef:	8b 55 08             	mov    0x8(%ebp),%edx
  8012f2:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8012f6:	89 74 24 08          	mov    %esi,0x8(%esp)
  8012fa:	89 44 24 04          	mov    %eax,0x4(%esp)
  8012fe:	c7 04 24 40 1a 80 00 	movl   $0x801a40,(%esp)
  801305:	e8 f0 ee ff ff       	call   8001fa <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80130a:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80130e:	8b 45 10             	mov    0x10(%ebp),%eax
  801311:	89 04 24             	mov    %eax,(%esp)
  801314:	e8 80 ee ff ff       	call   800199 <vcprintf>
	cprintf("\n");
  801319:	c7 04 24 87 16 80 00 	movl   $0x801687,(%esp)
  801320:	e8 d5 ee ff ff       	call   8001fa <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  801325:	cc                   	int3   
  801326:	eb fd                	jmp    801325 <_panic+0x53>

00801328 <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80132e:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  801335:	75 58                	jne    80138f <set_pgfault_handler+0x67>
	{
		// First time through!
		// LAB 4: Your code here.
		int check;
  ...
  801352:	e8 ec f8 ff ff       	call   800c43 <sys_page_alloc>
		if(check<0)
  801357:	85 c0                	test   %eax,%eax
  801359:	79 1c                	jns    801377 <set_pgfault_handler+0x4f>
		{
			panic("Sys_page alloc failed");
  80135b:	c7 44 24 08 64 1a 80 	movl   $0x801a64,0x8(%esp)
  801362:	00 
  801363:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  80136a:	00 
  80136b:	c7 04 24 7a 1a 80 00 	movl   $0x801a7a,(%esp)
  801372:	e8 5b ff ff ff       	call   8012d2 <_panic>
		}
		
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  801377:	a1 04 20 80 00       	mov    0x802004,%eax
  80137c:	8b 40 48             	mov    0x48(%eax),%eax
  80137f:	c7 44 24 04 99 13 80 	movl   $0x801399,0x4(%esp)
  801386:	00 
  801387:	89 04 24             	mov    %eax,(%esp)
  80138a:	e8 01 fa ff ff       	call   800d90 <sys_env_set_pgfault_upcall>
  ...
  801392:	a3 08 20 80 00       	mov    %eax,0x802008
}
  801397:	c9                   	leave  
  801398:	c3                   	ret    

00801399 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  80139a:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
