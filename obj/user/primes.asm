...
top:
  ...
  800052:	e8 9f 12 00 00       	call   8012f6 <ipc_recv>
  ...
  8000ba:	e8 37 12 00 00       	call   8012f6 <ipc_recv>
  ...
  8000df:	e8 34 12 00 00       	call   801318 <ipc_send>
...
umain(int argc, char **argv)
{
  ...
  80013e:	e8 d5 11 00 00       	call   801318 <ipc_send>
		panic("fork: %e", id);
	if (id == 0)
		primeproc();
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001d0:	c7 04 24 c4 16 80 00 	movl   $0x8016c4,(%esp)
  ...
  8001e6:	e8 51 00 00 00       	call   80023c <vcprintf>
	cprintf("\n");
  8001eb:	c7 04 24 e7 16 80 00 	movl   $0x8016e7,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80032f:	e8 dc 10 00 00       	call   801410 <__udivdi3>
  ...
  80038f:	e8 ac 11 00 00       	call   801540 <__umoddi3>
  800394:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800398:	0f be 80 e9 16 80 00 	movsbl 0x8016e9(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004b3:	ff 24 8d a0 17 80 00 	jmp    *0x8017a0(,%ecx,4)
  ...
  80057f:	c7 44 24 08 0a 17 80 	movl   $0x80170a,0x8(%esp)
  800586:	00 
  ...
  8005b1:	b8 fa 16 80 00       	mov    $0x8016fa,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 24 19 80 	movl   $0x801924,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 41 19 80 00 	movl   $0x801941,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d12:	00 
  800d13:	c7 44 24 08 24 19 80 	movl   $0x801924,0x8(%esp)
  800d1a:	00 
  800d1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d22:	00 
  800d23:	c7 04 24 41 19 80 00 	movl   $0x801941,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d65:	00 
  800d66:	c7 44 24 08 24 19 80 	movl   $0x801924,0x8(%esp)
  800d6d:	00 
  800d6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d75:	00 
  800d76:	c7 04 24 41 19 80 00 	movl   $0x801941,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800ed3:	00 
  800ed4:	c7 44 24 08 24 19 80 	movl   $0x801924,0x8(%esp)
  800edb:	00 
  800edc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ee3:	00 
  800ee4:	c7 04 24 41 19 80 00 	movl   $0x801941,(%esp)
...
pgfault(struct UTrapframe *utf)
{
  ...
  800f04:	8b 48 04             	mov    0x4(%eax),%ecx
  ...
  800f18:	75 21                	jne    800f3b <pgfault+0x43>
  800f1a:	f6 c1 02             	test   $0x2,%cl
  800f1d:	74 1c                	je     800f3b <pgfault+0x43>
		panic("Trying to write on a read only page or the error is not a Write error");
  800f1f:	c7 44 24 08 50 19 80 	movl   $0x801950,0x8(%esp)
  800f26:	00 
  800f27:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800f2e:	00 
  800f2f:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  800f36:	e8 69 f2 ff ff       	call   8001a4 <_panic>
  ...
  800f5a:	e8 84 fd ff ff       	call   800ce3 <sys_page_alloc>
  800f5f:	85 c0                	test   %eax,%eax
  800f61:	79 20                	jns    800f83 <pgfault+0x8b>
		panic("sys_page_alloc: %e", r);
  800f63:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f67:	c7 44 24 08 cf 19 80 	movl   $0x8019cf,0x8(%esp)
  800f6e:	00 
  800f6f:	c7 44 24 04 2d 00 00 	movl   $0x2d,0x4(%esp)
  800f76:	00 
  800f77:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  800f7e:	e8 21 f2 ff ff       	call   8001a4 <_panic>
		
	memmove((void *)PFTEMP, vAddr, PGSIZE);
  800f83:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f8a:	00 
  800f8b:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f8f:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f96:	e8 c9 fa ff ff       	call   800a64 <memmove>
	
	if ((r = sys_page_map(0, (void *)PFTEMP, 0, vAddr, PTE_P|PTE_U|PTE_W)) < 0)
  800f9b:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800fa2:	00 
  800fa3:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  800fa7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800fae:	00 
  800faf:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800fb6:	00 
  800fb7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800fbe:	e8 74 fd ff ff       	call   800d37 <sys_page_map>
  800fc3:	85 c0                	test   %eax,%eax
  800fc5:	79 20                	jns    800fe7 <pgfault+0xef>
		panic("sys_page_map: %e", r);
  800fc7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fcb:	c7 44 24 08 e2 19 80 	movl   $0x8019e2,0x8(%esp)
  800fd2:	00 
  800fd3:	c7 44 24 04 32 00 00 	movl   $0x32,0x4(%esp)
  800fda:	00 
  800fdb:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  800fe2:	e8 bd f1 ff ff       	call   8001a4 <_panic>
  ...
  800ff6:	e8 8f fd ff ff       	call   800d8a <sys_page_unmap>
  800ffb:	85 c0                	test   %eax,%eax
  800ffd:	79 20                	jns    80101f <pgfault+0x127>
		panic("sys_page_unmap: %e", r);
  800fff:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801003:	c7 44 24 08 f3 19 80 	movl   $0x8019f3,0x8(%esp)
  80100a:	00 
  80100b:	c7 44 24 04 37 00 00 	movl   $0x37,0x4(%esp)
  801012:	00 
  801013:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  80101a:	e8 85 f1 ff ff       	call   8001a4 <_panic>

}
  80101f:	83 c4 24             	add    $0x24,%esp
  801022:	5b                   	pop    %ebx
  801023:	5d                   	pop    %ebp
  801024:	c3                   	ret    
...
fork(void)
{
  ...
  80102e:	c7 04 24 f8 0e 80 00 	movl   $0x800ef8,(%esp)
  801035:	e8 38 03 00 00       	call   801372 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  801043:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	
	envid = sys_exofork();
	//cprintf("envId=%d",envid);
	if (envid < 0)
  801046:	85 c0                	test   %eax,%eax
  801048:	79 20                	jns    80106a <fork+0x45>
		panic("sys_exofork: %e", envid);
  80104a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80104e:	c7 44 24 08 06 1a 80 	movl   $0x801a06,0x8(%esp)
  801055:	00 
  801056:	c7 44 24 04 83 00 00 	movl   $0x83,0x4(%esp)
  80105d:	00 
  80105e:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  801065:	e8 3a f1 ff ff       	call   8001a4 <_panic>
	if (envid == 0) {
  80106a:	bb 00 08 00 00       	mov    $0x800,%ebx
  80106f:	85 c0                	test   %eax,%eax
  801071:	75 21                	jne    801094 <fork+0x6f>
		// We're the child.
		// The copied value of the global variable 'thisenv'
		// is no longer valid (it refers to the parent!).
		// Fix it and return 0.
		thisenv = &envs[ENVX(sys_getenvid())];
  801073:	e8 2d fc ff ff       	call   800ca5 <sys_getenvid>
  801078:	25 ff 03 00 00       	and    $0x3ff,%eax
  80107d:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801080:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801085:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  80108a:	b8 00 00 00 00       	mov    $0x0,%eax
  80108f:	e9 38 02 00 00       	jmp    8012cc <fork+0x2a7>
	}
	uint32_t i=0;
  ...
  8010a8:	0f 84 69 01 00 00    	je     801217 <fork+0x1f2>
		if(!(uvpt[pn] & PTE_P)) continue;
  8010ae:	8b 14 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%edx
  8010b5:	f6 c2 01             	test   $0x1,%dl
  8010b8:	0f 84 59 01 00 00    	je     801217 <fork+0x1f2>
		if((pn << PGSHIFT) < (UXSTACKTOP - PGSIZE))
  8010be:	3d ff ef bf ee       	cmp    $0xeebfefff,%eax
  8010c3:	0f 87 4e 01 00 00    	ja     801217 <fork+0x1f2>
  ...
  8010cb:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  8010d2:	a8 02                	test   $0x2,%al
  8010d4:	75 10                	jne    8010e6 <fork+0xc1>
  8010d6:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  8010dd:	f6 c4 08             	test   $0x8,%ah
  8010e0:	0f 84 93 00 00 00    	je     801179 <fork+0x154>
	{
  ...
  801104:	e8 2e fc ff ff       	call   800d37 <sys_page_map>
  801109:	85 c0                	test   %eax,%eax
  80110b:	79 20                	jns    80112d <fork+0x108>
			panic("sys_page_map: %e", r);
  80110d:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801111:	c7 44 24 08 e2 19 80 	movl   $0x8019e2,0x8(%esp)
  801118:	00 
  801119:	c7 44 24 04 56 00 00 	movl   $0x56,0x4(%esp)
  801120:	00 
  801121:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  801128:	e8 77 f0 ff ff       	call   8001a4 <_panic>
		if ((r = sys_page_map(0, address, 0, address, perm)) < 0)
  80112d:	c7 44 24 10 05 08 00 	movl   $0x805,0x10(%esp)
  801134:	00 
  801135:	89 74 24 0c          	mov    %esi,0xc(%esp)
  801139:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801140:	00 
  801141:	89 74 24 04          	mov    %esi,0x4(%esp)
  801145:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80114c:	e8 e6 fb ff ff       	call   800d37 <sys_page_map>
  801151:	85 c0                	test   %eax,%eax
  801153:	0f 89 be 00 00 00    	jns    801217 <fork+0x1f2>
			panic("sys_page_map: %e", r);
  801159:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80115d:	c7 44 24 08 e2 19 80 	movl   $0x8019e2,0x8(%esp)
  801164:	00 
  801165:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80116c:	00 
  80116d:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  801174:	e8 2b f0 ff ff       	call   8001a4 <_panic>
	}

	else if(uvpt[pn] & PTE_U)
  801179:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  801180:	a8 04                	test   $0x4,%al
  801182:	0f 84 8f 00 00 00    	je     801217 <fork+0x1f2>
	{
		if ((r = sys_page_map(0, address, envid, address, perm1)) < 0)
  801188:	c7 44 24 10 05 00 00 	movl   $0x5,0x10(%esp)
  80118f:	00 
  801190:	89 74 24 0c          	mov    %esi,0xc(%esp)
  ...
  8011a6:	e8 8c fb ff ff       	call   800d37 <sys_page_map>
  8011ab:	85 c0                	test   %eax,%eax
  8011ad:	79 20                	jns    8011cf <fork+0x1aa>
			panic("sys_page_map: %e", r);
  8011af:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011b3:	c7 44 24 08 e2 19 80 	movl   $0x8019e2,0x8(%esp)
  8011ba:	00 
  8011bb:	c7 44 24 04 5e 00 00 	movl   $0x5e,0x4(%esp)
  8011c2:	00 
  8011c3:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  8011ca:	e8 d5 ef ff ff       	call   8001a4 <_panic>
		if ((r = sys_page_map(0, address, 0, address, perm1)) < 0)
  8011cf:	c7 44 24 10 05 00 00 	movl   $0x5,0x10(%esp)
  8011d6:	00 
  8011d7:	89 74 24 0c          	mov    %esi,0xc(%esp)
  8011db:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8011e2:	00 
  8011e3:	89 74 24 04          	mov    %esi,0x4(%esp)
  8011e7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8011ee:	e8 44 fb ff ff       	call   800d37 <sys_page_map>
  8011f3:	85 c0                	test   %eax,%eax
  8011f5:	79 20                	jns    801217 <fork+0x1f2>
			panic("sys_page_map: %e", r);
  8011f7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011fb:	c7 44 24 08 e2 19 80 	movl   $0x8019e2,0x8(%esp)
  801202:	00 
  801203:	c7 44 24 04 60 00 00 	movl   $0x60,0x4(%esp)
  80120a:	00 
  80120b:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  801212:	e8 8d ef ff ff       	call   8001a4 <_panic>
		// Fix it and return 0.
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
  ...
  80121a:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  801220:	0f 85 6e fe ff ff    	jne    801094 <fork+0x6f>
  ...
  801239:	e8 a5 fa ff ff       	call   800ce3 <sys_page_alloc>
  80123e:	85 c0                	test   %eax,%eax
  801240:	79 20                	jns    801262 <fork+0x23d>
		panic("sys_page_alloc: %e", r);
  801242:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801246:	c7 44 24 08 cf 19 80 	movl   $0x8019cf,0x8(%esp)
  80124d:	00 
  80124e:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  801255:	00 
  801256:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  80125d:	e8 42 ef ff ff       	call   8001a4 <_panic>
		
	int status;
	if((status =sys_env_set_pgfault_upcall(envid, thisenv->env_pgfault_upcall)) < 0)
  801262:	a1 04 20 80 00       	mov    0x802004,%eax
  801267:	8b 40 60             	mov    0x60(%eax),%eax
  80126a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80126e:	89 3c 24             	mov    %edi,(%esp)
  801271:	e8 ba fb ff ff       	call   800e30 <sys_env_set_pgfault_upcall>
  801276:	85 c0                	test   %eax,%eax
  801278:	79 1c                	jns    801296 <fork+0x271>
		panic("Bad Environment in user pagefault handler");
  80127a:	c7 44 24 08 98 19 80 	movl   $0x801998,0x8(%esp)
  801281:	00 
  801282:	c7 44 24 04 a0 00 00 	movl   $0xa0,0x4(%esp)
  801289:	00 
  80128a:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  801291:	e8 0e ef ff ff       	call   8001a4 <_panic>
			
	if ((r = sys_env_set_status(envid, ENV_RUNNABLE)) < 0)
  801296:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  80129d:	00 
  80129e:	89 3c 24             	mov    %edi,(%esp)
  8012a1:	e8 37 fb ff ff       	call   800ddd <sys_env_set_status>
  8012a6:	85 c0                	test   %eax,%eax
  8012a8:	79 20                	jns    8012ca <fork+0x2a5>
		panic("sys_env_set_status: %e", r);
  8012aa:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8012ae:	c7 44 24 08 16 1a 80 	movl   $0x801a16,0x8(%esp)
  8012b5:	00 
  8012b6:	c7 44 24 04 a3 00 00 	movl   $0xa3,0x4(%esp)
  8012bd:	00 
  8012be:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  8012c5:	e8 da ee ff ff       	call   8001a4 <_panic>
...
sfork(void)
{
  ...
  8012da:	c7 44 24 08 2d 1a 80 	movl   $0x801a2d,0x8(%esp)
  8012e1:	00 
  8012e2:	c7 44 24 04 ac 00 00 	movl   $0xac,0x4(%esp)
  8012e9:	00 
  8012ea:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  8012f1:	e8 ae ee ff ff       	call   8001a4 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8012fc:	c7 44 24 08 43 1a 80 	movl   $0x801a43,0x8(%esp)
  801303:	00 
  801304:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  80130b:	00 
  80130c:	c7 04 24 5c 1a 80 00 	movl   $0x801a5c,(%esp)
  801313:	e8 8c ee ff ff       	call   8001a4 <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80131e:	c7 44 24 08 66 1a 80 	movl   $0x801a66,0x8(%esp)
  801325:	00 
  801326:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80132d:	00 
  80132e:	c7 04 24 5c 1a 80 00 	movl   $0x801a5c,(%esp)
  801335:	e8 6a ee ff ff       	call   8001a4 <_panic>

0080133a <ipc_find_env>:
...
ipc_find_env(enum EnvType type)
{
  ...
  801345:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801348:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  80134e:	8b 52 50             	mov    0x50(%edx),%edx
  801351:	39 ca                	cmp    %ecx,%edx
  801353:	75 0d                	jne    801362 <ipc_find_env+0x28>
			return envs[i].env_id;
  801355:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801358:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  80135d:	8b 40 40             	mov    0x40(%eax),%eax
  801360:	eb 0e                	jmp    801370 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  801362:	83 c0 01             	add    $0x1,%eax
  801365:	3d 00 04 00 00       	cmp    $0x400,%eax
  80136a:	75 d9                	jne    801345 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  80136c:	66 b8 00 00          	mov    $0x0,%ax
}
  801370:	5d                   	pop    %ebp
  801371:	c3                   	ret    

00801372 <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801378:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  80137f:	75 58                	jne    8013d9 <set_pgfault_handler+0x67>
	{
		// First time through!
		// LAB 4: Your code here.
		int check;
  ...
  80139c:	e8 42 f9 ff ff       	call   800ce3 <sys_page_alloc>
		if(check<0)
  8013a1:	85 c0                	test   %eax,%eax
  8013a3:	79 1c                	jns    8013c1 <set_pgfault_handler+0x4f>
		{
			panic("Sys_page alloc failed");
  8013a5:	c7 44 24 08 7f 1a 80 	movl   $0x801a7f,0x8(%esp)
  8013ac:	00 
  8013ad:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  8013b4:	00 
  8013b5:	c7 04 24 95 1a 80 00 	movl   $0x801a95,(%esp)
  8013bc:	e8 e3 ed ff ff       	call   8001a4 <_panic>
		}
		
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  8013c1:	a1 04 20 80 00       	mov    0x802004,%eax
  8013c6:	8b 40 48             	mov    0x48(%eax),%eax
  8013c9:	c7 44 24 04 e3 13 80 	movl   $0x8013e3,0x4(%esp)
  8013d0:	00 
  8013d1:	89 04 24             	mov    %eax,(%esp)
  8013d4:	e8 57 fa ff ff       	call   800e30 <sys_env_set_pgfault_upcall>
...
_pgfault_upcall:
  ...
  8013ee:	89 e3                	mov    %esp,%ebx
		movl 40(%esp),%eax   // store eip value
  8013f0:	8b 44 24 28          	mov    0x28(%esp),%eax
		movl 48(%esp),%esp   // get new esp value
  8013f4:	8b 64 24 30          	mov    0x30(%esp),%esp
		pushl %eax          // push eip in the free space
  8013f8:	50                   	push   %eax
		movl %ebx,%esp	    // get back to prev	
  8013f9:	89 dc                	mov    %ebx,%esp
		subl $4,48(%esp)
  8013fb:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
