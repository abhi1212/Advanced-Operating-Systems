...
umain(int argc, char **argv)
{
  ...
  80004e:	e8 6b 01 00 00       	call   8001be <cprintf>
	if ((env = fork()) == 0) {
  800053:	e8 ed 0e 00 00       	call   800f45 <fork>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	e8 bc 10 00 00       	call   801310 <__udivdi3>
  ...
  8002af:	e8 8c 11 00 00       	call   801440 <__umoddi3>
  8002b4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002b8:	0f be 80 40 16 80 00 	movsbl 0x801640(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003d3:	ff 24 8d 00 17 80 00 	jmp    *0x801700(,%ecx,4)
  ...
  80049f:	c7 44 24 08 61 16 80 	movl   $0x801661,0x8(%esp)
  8004a6:	00 
  ...
  8004d1:	b8 51 16 80 00       	mov    $0x801651,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ba0:	00 
  800ba1:	c7 44 24 08 84 18 80 	movl   $0x801884,0x8(%esp)
  800ba8:	00 
  800ba9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bb0:	00 
  800bb1:	c7 04 24 a1 18 80 00 	movl   $0x8018a1,(%esp)
  800bb8:	e8 59 06 00 00       	call   801216 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c32:	00 
  800c33:	c7 44 24 08 84 18 80 	movl   $0x801884,0x8(%esp)
  800c3a:	00 
  800c3b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c42:	00 
  800c43:	c7 04 24 a1 18 80 00 	movl   $0x8018a1,(%esp)
  800c4a:	e8 c7 05 00 00       	call   801216 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c85:	00 
  800c86:	c7 44 24 08 84 18 80 	movl   $0x801884,0x8(%esp)
  800c8d:	00 
  800c8e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c95:	00 
  800c96:	c7 04 24 a1 18 80 00 	movl   $0x8018a1,(%esp)
  800c9d:	e8 74 05 00 00       	call   801216 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cd8:	00 
  800cd9:	c7 44 24 08 84 18 80 	movl   $0x801884,0x8(%esp)
  800ce0:	00 
  800ce1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce8:	00 
  800ce9:	c7 04 24 a1 18 80 00 	movl   $0x8018a1,(%esp)
  800cf0:	e8 21 05 00 00       	call   801216 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d2b:	00 
  800d2c:	c7 44 24 08 84 18 80 	movl   $0x801884,0x8(%esp)
  800d33:	00 
  800d34:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3b:	00 
  800d3c:	c7 04 24 a1 18 80 00 	movl   $0x8018a1,(%esp)
  800d43:	e8 ce 04 00 00       	call   801216 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d7e:	00 
  800d7f:	c7 44 24 08 84 18 80 	movl   $0x801884,0x8(%esp)
  800d86:	00 
  800d87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8e:	00 
  800d8f:	c7 04 24 a1 18 80 00 	movl   $0x8018a1,(%esp)
  800d96:	e8 7b 04 00 00       	call   801216 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800df3:	00 
  800df4:	c7 44 24 08 84 18 80 	movl   $0x801884,0x8(%esp)
  800dfb:	00 
  800dfc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e03:	00 
  800e04:	c7 04 24 a1 18 80 00 	movl   $0x8018a1,(%esp)
  800e0b:	e8 06 04 00 00       	call   801216 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e24:	8b 48 04             	mov    0x4(%eax),%ecx
  ...
  800e2c:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800e33:	a9 02 08 00 00       	test   $0x802,%eax
  800e38:	75 21                	jne    800e5b <pgfault+0x43>
  800e3a:	f6 c1 02             	test   $0x2,%cl
  800e3d:	74 1c                	je     800e5b <pgfault+0x43>
		panic("Trying to write on a read only page or the error is not a Write error");
  800e3f:	c7 44 24 08 b0 18 80 	movl   $0x8018b0,0x8(%esp)
  800e46:	00 
  800e47:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e4e:	00 
  800e4f:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  800e56:	e8 bb 03 00 00       	call   801216 <_panic>
  ...
  800e7a:	e8 84 fd ff ff       	call   800c03 <sys_page_alloc>
  800e7f:	85 c0                	test   %eax,%eax
  800e81:	79 20                	jns    800ea3 <pgfault+0x8b>
		panic("sys_page_alloc: %e", r);
  800e83:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800e87:	c7 44 24 08 2d 19 80 	movl   $0x80192d,0x8(%esp)
  800e8e:	00 
  800e8f:	c7 44 24 04 2d 00 00 	movl   $0x2d,0x4(%esp)
  800e96:	00 
  800e97:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  800e9e:	e8 73 03 00 00       	call   801216 <_panic>
		
	memmove((void *)PFTEMP, vAddr, PGSIZE);
  800ea3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800eaa:	00 
  800eab:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800eaf:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800eb6:	e8 c9 fa ff ff       	call   800984 <memmove>
	
	if ((r = sys_page_map(0, (void *)PFTEMP, 0, vAddr, PTE_P|PTE_U|PTE_W)) < 0)
  800ebb:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800ec2:	00 
  800ec3:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  800ec7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800ece:	00 
  800ecf:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800ed6:	00 
  800ed7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800ede:	e8 74 fd ff ff       	call   800c57 <sys_page_map>
  800ee3:	85 c0                	test   %eax,%eax
  800ee5:	79 20                	jns    800f07 <pgfault+0xef>
		panic("sys_page_map: %e", r);
  800ee7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800eeb:	c7 44 24 08 40 19 80 	movl   $0x801940,0x8(%esp)
  800ef2:	00 
  800ef3:	c7 44 24 04 32 00 00 	movl   $0x32,0x4(%esp)
  800efa:	00 
  800efb:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  800f02:	e8 0f 03 00 00       	call   801216 <_panic>
  ...
  800f16:	e8 8f fd ff ff       	call   800caa <sys_page_unmap>
  800f1b:	85 c0                	test   %eax,%eax
  800f1d:	79 20                	jns    800f3f <pgfault+0x127>
		panic("sys_page_unmap: %e", r);
  800f1f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f23:	c7 44 24 08 51 19 80 	movl   $0x801951,0x8(%esp)
  800f2a:	00 
  800f2b:	c7 44 24 04 37 00 00 	movl   $0x37,0x4(%esp)
  800f32:	00 
  800f33:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  800f3a:	e8 d7 02 00 00       	call   801216 <_panic>

}
  800f3f:	83 c4 24             	add    $0x24,%esp
  800f42:	5b                   	pop    %ebx
  800f43:	5d                   	pop    %ebp
  800f44:	c3                   	ret    
...
fork(void)
{
  ...
  800f4e:	c7 04 24 18 0e 80 00 	movl   $0x800e18,(%esp)
  800f55:	e8 12 03 00 00       	call   80126c <set_pgfault_handler>
...
sys_exofork(void)
{
	envid_t ret;
	asm volatile("int %2"
  800f5a:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800f68:	79 20                	jns    800f8a <fork+0x45>
		panic("sys_exofork: %e", envid);
  800f6a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f6e:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  800f75:	00 
  800f76:	c7 44 24 04 83 00 00 	movl   $0x83,0x4(%esp)
  800f7d:	00 
  800f7e:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  800f85:	e8 8c 02 00 00       	call   801216 <_panic>
	if (envid == 0) {
  800f8a:	bb 00 08 00 00       	mov    $0x800,%ebx
  800f8f:	85 c0                	test   %eax,%eax
  800f91:	75 21                	jne    800fb4 <fork+0x6f>
		// We're the child.
		// The copied value of the global variable 'thisenv'
		// is no longer valid (it refers to the parent!).
		// Fix it and return 0.
		thisenv = &envs[ENVX(sys_getenvid())];
  800f93:	e8 2d fc ff ff       	call   800bc5 <sys_getenvid>
  800f98:	25 ff 03 00 00       	and    $0x3ff,%eax
  800f9d:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800fa0:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800fa5:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  800faa:	b8 00 00 00 00       	mov    $0x0,%eax
  800faf:	e9 38 02 00 00       	jmp    8011ec <fork+0x2a7>
	}
	uint32_t i=0;
  ...
  800fc8:	0f 84 69 01 00 00    	je     801137 <fork+0x1f2>
		if(!(uvpt[pn] & PTE_P)) continue;
  800fce:	8b 14 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%edx
  800fd5:	f6 c2 01             	test   $0x1,%dl
  800fd8:	0f 84 59 01 00 00    	je     801137 <fork+0x1f2>
		if((pn << PGSHIFT) < (UXSTACKTOP - PGSIZE))
  800fde:	3d ff ef bf ee       	cmp    $0xeebfefff,%eax
  800fe3:	0f 87 4e 01 00 00    	ja     801137 <fork+0x1f2>
  ...
  800ff4:	75 10                	jne    801006 <fork+0xc1>
  800ff6:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800ffd:	f6 c4 08             	test   $0x8,%ah
  801000:	0f 84 93 00 00 00    	je     801099 <fork+0x154>
	{
		
	
		if ((r = sys_page_map(0, address, envid, address, perm)) < 0)
  801006:	c7 44 24 10 05 08 00 	movl   $0x805,0x10(%esp)
  80100d:	00 
  80100e:	89 74 24 0c          	mov    %esi,0xc(%esp)
  ...
  801024:	e8 2e fc ff ff       	call   800c57 <sys_page_map>
  801029:	85 c0                	test   %eax,%eax
  80102b:	79 20                	jns    80104d <fork+0x108>
			panic("sys_page_map: %e", r);
  80102d:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801031:	c7 44 24 08 40 19 80 	movl   $0x801940,0x8(%esp)
  801038:	00 
  801039:	c7 44 24 04 56 00 00 	movl   $0x56,0x4(%esp)
  801040:	00 
  801041:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  801048:	e8 c9 01 00 00       	call   801216 <_panic>
		if ((r = sys_page_map(0, address, 0, address, perm)) < 0)
  80104d:	c7 44 24 10 05 08 00 	movl   $0x805,0x10(%esp)
  801054:	00 
  801055:	89 74 24 0c          	mov    %esi,0xc(%esp)
  801059:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801060:	00 
  801061:	89 74 24 04          	mov    %esi,0x4(%esp)
  801065:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80106c:	e8 e6 fb ff ff       	call   800c57 <sys_page_map>
  801071:	85 c0                	test   %eax,%eax
  801073:	0f 89 be 00 00 00    	jns    801137 <fork+0x1f2>
			panic("sys_page_map: %e", r);
  801079:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80107d:	c7 44 24 08 40 19 80 	movl   $0x801940,0x8(%esp)
  801084:	00 
  801085:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80108c:	00 
  80108d:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  801094:	e8 7d 01 00 00       	call   801216 <_panic>
	}

	else if(uvpt[pn] & PTE_U)
  801099:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  8010a0:	a8 04                	test   $0x4,%al
  8010a2:	0f 84 8f 00 00 00    	je     801137 <fork+0x1f2>
	{
		if ((r = sys_page_map(0, address, envid, address, perm1)) < 0)
  8010a8:	c7 44 24 10 05 00 00 	movl   $0x5,0x10(%esp)
  8010af:	00 
  8010b0:	89 74 24 0c          	mov    %esi,0xc(%esp)
  8010b4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8010b7:	89 44 24 08          	mov    %eax,0x8(%esp)
  8010bb:	89 74 24 04          	mov    %esi,0x4(%esp)
  8010bf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010c6:	e8 8c fb ff ff       	call   800c57 <sys_page_map>
  8010cb:	85 c0                	test   %eax,%eax
  8010cd:	79 20                	jns    8010ef <fork+0x1aa>
			panic("sys_page_map: %e", r);
  8010cf:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010d3:	c7 44 24 08 40 19 80 	movl   $0x801940,0x8(%esp)
  8010da:	00 
  8010db:	c7 44 24 04 5e 00 00 	movl   $0x5e,0x4(%esp)
  8010e2:	00 
  8010e3:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  8010ea:	e8 27 01 00 00       	call   801216 <_panic>
		if ((r = sys_page_map(0, address, 0, address, perm1)) < 0)
  8010ef:	c7 44 24 10 05 00 00 	movl   $0x5,0x10(%esp)
  8010f6:	00 
  8010f7:	89 74 24 0c          	mov    %esi,0xc(%esp)
  8010fb:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801102:	00 
  801103:	89 74 24 04          	mov    %esi,0x4(%esp)
  801107:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80110e:	e8 44 fb ff ff       	call   800c57 <sys_page_map>
  801113:	85 c0                	test   %eax,%eax
  801115:	79 20                	jns    801137 <fork+0x1f2>
			panic("sys_page_map: %e", r);
  801117:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80111b:	c7 44 24 08 40 19 80 	movl   $0x801940,0x8(%esp)
  801122:	00 
  801123:	c7 44 24 04 60 00 00 	movl   $0x60,0x4(%esp)
  80112a:	00 
  80112b:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  801132:	e8 df 00 00 00       	call   801216 <_panic>
		// Fix it and return 0.
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
  ...
  80113a:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  801140:	0f 85 6e fe ff ff    	jne    800fb4 <fork+0x6f>
  ...
  801159:	e8 a5 fa ff ff       	call   800c03 <sys_page_alloc>
  80115e:	85 c0                	test   %eax,%eax
  801160:	79 20                	jns    801182 <fork+0x23d>
		panic("sys_page_alloc: %e", r);
  801162:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801166:	c7 44 24 08 2d 19 80 	movl   $0x80192d,0x8(%esp)
  80116d:	00 
  80116e:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  801175:	00 
  801176:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  80117d:	e8 94 00 00 00       	call   801216 <_panic>
		
	int status;
	if((status =sys_env_set_pgfault_upcall(envid, thisenv->env_pgfault_upcall)) < 0)
  801182:	a1 04 20 80 00       	mov    0x802004,%eax
  801187:	8b 40 60             	mov    0x60(%eax),%eax
  80118a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80118e:	89 3c 24             	mov    %edi,(%esp)
  801191:	e8 ba fb ff ff       	call   800d50 <sys_env_set_pgfault_upcall>
  801196:	85 c0                	test   %eax,%eax
  801198:	79 1c                	jns    8011b6 <fork+0x271>
		panic("Bad Environment in user pagefault handler");
  80119a:	c7 44 24 08 f8 18 80 	movl   $0x8018f8,0x8(%esp)
  8011a1:	00 
  8011a2:	c7 44 24 04 a0 00 00 	movl   $0xa0,0x4(%esp)
  8011a9:	00 
  8011aa:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  8011b1:	e8 60 00 00 00       	call   801216 <_panic>
			
	if ((r = sys_env_set_status(envid, ENV_RUNNABLE)) < 0)
  8011b6:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  8011bd:	00 
  8011be:	89 3c 24             	mov    %edi,(%esp)
  8011c1:	e8 37 fb ff ff       	call   800cfd <sys_env_set_status>
  8011c6:	85 c0                	test   %eax,%eax
  8011c8:	79 20                	jns    8011ea <fork+0x2a5>
		panic("sys_env_set_status: %e", r);
  8011ca:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011ce:	c7 44 24 08 74 19 80 	movl   $0x801974,0x8(%esp)
  8011d5:	00 
  8011d6:	c7 44 24 04 a3 00 00 	movl   $0xa3,0x4(%esp)
  8011dd:	00 
  8011de:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  8011e5:	e8 2c 00 00 00       	call   801216 <_panic>
...
sfork(void)
{
  ...
  8011fa:	c7 44 24 08 8b 19 80 	movl   $0x80198b,0x8(%esp)
  801201:	00 
  801202:	c7 44 24 04 ac 00 00 	movl   $0xac,0x4(%esp)
  801209:	00 
  80120a:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  801211:	e8 00 00 00 00       	call   801216 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801227:	e8 99 f9 ff ff       	call   800bc5 <sys_getenvid>
  ...
  801242:	c7 04 24 a4 19 80 00 	movl   $0x8019a4,(%esp)
  801249:	e8 70 ef ff ff       	call   8001be <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80124e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801252:	8b 45 10             	mov    0x10(%ebp),%eax
  801255:	89 04 24             	mov    %eax,(%esp)
  801258:	e8 00 ef ff ff       	call   80015d <vcprintf>
	cprintf("\n");
  80125d:	c7 04 24 34 16 80 00 	movl   $0x801634,(%esp)
  801264:	e8 55 ef ff ff       	call   8001be <cprintf>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801272:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  801279:	75 58                	jne    8012d3 <set_pgfault_handler+0x67>
	{
		// First time through!
		// LAB 4: Your code here.
		int check;
		check=sys_page_alloc(thisenv->env_id, (void *)(UXSTACKTOP-PGSIZE),  PTE_U|PTE_W|PTE_P);
  80127b:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  801296:	e8 68 f9 ff ff       	call   800c03 <sys_page_alloc>
		if(check<0)
  80129b:	85 c0                	test   %eax,%eax
  80129d:	79 1c                	jns    8012bb <set_pgfault_handler+0x4f>
		{
			panic("Sys_page alloc failed");
  80129f:	c7 44 24 08 c8 19 80 	movl   $0x8019c8,0x8(%esp)
  8012a6:	00 
  8012a7:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  8012ae:	00 
  8012af:	c7 04 24 de 19 80 00 	movl   $0x8019de,(%esp)
  8012b6:	e8 5b ff ff ff       	call   801216 <_panic>
		}
		
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  8012bb:	a1 04 20 80 00       	mov    0x802004,%eax
  8012c0:	8b 40 48             	mov    0x48(%eax),%eax
  8012c3:	c7 44 24 04 dd 12 80 	movl   $0x8012dd,0x4(%esp)
  8012ca:	00 
  8012cb:	89 04 24             	mov    %eax,(%esp)
  8012ce:	e8 7d fa ff ff       	call   800d50 <sys_env_set_pgfault_upcall>
  ...
  8012d6:	a3 08 20 80 00       	mov    %eax,0x802008
}
  8012db:	c9                   	leave  
  8012dc:	c3                   	ret    
...
_pgfault_upcall:
  ...
  8012de:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  8012e8:	89 e3                	mov    %esp,%ebx
		movl 40(%esp),%eax   // store eip value
  8012ea:	8b 44 24 28          	mov    0x28(%esp),%eax
		movl 48(%esp),%esp   // get new esp value
  8012ee:	8b 64 24 30          	mov    0x30(%esp),%esp
		pushl %eax          // push eip in the free space
  8012f2:	50                   	push   %eax
		movl %ebx,%esp	    // get back to prev	
  8012f3:	89 dc                	mov    %ebx,%esp
		subl $4,48(%esp)
  8012f5:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
